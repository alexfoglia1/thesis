...
\begin{tabular}{|c|c|c|c|}
	...
	\hline 
\end{tabular} 
\caption{Protocollo di comunicazione sensori-SFA}
\label{tab:protoin}
\end{table}\newpage
...
La trasmissione dei dati in uscita da SFA avviene tra \texttt{listener} e OBCU, o comunque, tra \texttt{listener} e qualunque host arbitrario che intenda ricevere le informazioni in uscita, come ad esempio un \texttt{PC} sul quale viene eseguito RTT.\\*
